...
const validationSchema = Yup.object().shape({
  ...
  interviews: Yup.number().typeError('Number of interviews must be a number').required('Number of interviews is required'),
          ...
          <Box p={2}>
            <form onSubmit={formik.handleSubmit}>
              <TextField
                ...
                sx={{ height: '80px' }} 
                mb={2}
                error={formik.touched.planName && formik.errors.planName ? true : false}
...
<TextField
  ...
  sx={{ height: '80px' }}
  mb={2}
  error={formik.touched.validity && formik.errors.validity ? true : false}
...
/>         <TextField
                ...
                sx={{ height: '80px' }} 
                mb={2}
                error={formik.touched.interviews && formik.errors.interviews ? true : false}
                helperText={formik.touched.interviews && formik.errors.interviews}
              />
              <TextField
                label="Features"
                variant="outlined"
                ...
                sx={{ height: '100px' }} 
                mb={2}
                error={formik.touched.features && formik.errors.features ? true : false}
                helperText={formik.touched.features && formik.errors.features}
              />
              <Button variant="contained" type="submit" fullWidth  sx={{mt:"20px"}}>
                Add Plan
              </Button>
            </form>
          </Box>
