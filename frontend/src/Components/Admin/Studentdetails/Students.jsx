...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, TablePagination, Stack, Pagination } from '@mui/material';
...
const Student = () => {
  ...
  return (
    <div>
      ...
      <Stack spacing={2} style={{ marginTop: '2rem', display: 'flex', alignItems: 'center' }}>
        <Pagination count={Math.ceil(Data?.length / rowsPerPage)} shape="roundedpage"onChange={handleChangePage} />
      </Stack>
    </div>
  );
};
